...
::: {#tbl-vocab}
  **Term**        **Plain meaning**                    **FastGoods example**
  ...
  Risk            Likelihood ×        impact of harm   Account takeover (R1)
...
Three of the six terms below are the protection goals of @def-cia; the
other three are distractors. Drag each protection goal onto the corner of the
...
::: {#exr-01-pillars-interactive}
## The three pillars, interactive

Drag each element of the Norsk Hydro handling (and of everyday practice) onto the pillar it belongs to.
 ...
 "buckets": [
  {
   "id": "gov",
   "label": "Governance",
   "desc": "direction and accountability"
  },
  {
   "id": "risk",
   "label": "Risk management",
   "desc": "judge and treat what could go wrong"
  },
  {
   "id": "comp",
   "label": "Compliance",
   "desc": "meet binding and adopted norms"
  }
 ],
 "chips": [
  {
   "t": "Leadership decides not to pay the ransom",
   "b": "gov"
  },
  {
   "t": "Backups bought and tested in advance",
   "b": "risk"
  },
  {
   "t": "Stock-exchange notice before the market opens",
   "b": "comp"
  },
  {
   "t": "Declaring customer data a protection priority",
   "b": "gov"
  },
  {
   "t": "Cyber-insurance as a transfer of risk",
   "b": "risk"
  },
  {
   "t": "Honouring the GDPR because personal data is held",
   "b": "comp"
  }
 ],
 "explain": "Governance decides and is answerable, risk management prepares in advance, compliance meets obligations - the praised Hydro handling contains all three.",
 "ref": "sec-01-the-three-pillars-one-at-a",
 "reflabel": "The three pillars"
}
</script>
</div>
```
...
::: {#exr-01-vocab-interactive}
## The vocabulary chain, interactive

Place each FastGoods item on the term of the core vocabulary it instantiates.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "The customer database",
   "b": "asset"
  },
  {
   "t": "A hacker after data to sell",
   "b": "threat"
  },
  {
   "t": "No multi-factor login",
   "b": "vuln"
  },
  {
   "t": "Account takeover (R1)",
   "b": "riskt"
  },
  {
   "t": "Requiring MFA",
 ...
 "explain": "A risk arises where a threat meets a vulnerability in something of value, and a control breaks exactly that chain.",
 "ref": "sec-01-the-core-vocabulary-from-threat-to",
 "reflabel": "The core vocabulary"
}
</script>
</div>
```
...
::: {#exr-01-norms-interactive}
## Binding or adopted, interactive

Sort the norms FastGoods lives under.
 ...
 "buckets": [
  {
   "id": "bind",
   "label": "Binding norm",
   "desc": "applies whether chosen or not"
  },
  {
   "id": "adopt",
   "label": "Adopted norm",
   "desc": "chosen, then committing"
  }
 ],
 "chips": [
  {
  ...
  {
   "t": "An ISO/IEC 27001 certification",
   "b": "adopt"
  },
  {
   "t": "PCI DSS, through the payment contract",
   "b": "adopt"
  },
  {
   "t": "The company's own password policy",
   "b": "adopt"
  }
 ],
 "explain": "Binding norms apply whether chosen or not; adopted norms bind only once chosen - but then they commit you all the same.",
 "ref": "sec-01-the-three-pillars-one-at-a",
 "reflabel": "The three pillars"
}
</script>
...
::: {#exr-01-lifecycle-interactive}
## The risk-management lifecycle, interactive

Order the recurring loop of managing risk.
...
<script type="application/json">
{
 "steps": [
  "Identify the risks",
  "Analyse and rate them",
  "Treat what is above appetite",
  "Monitor and review"
 ],
 "explain": "Risk management is a loop, not a one-off project: What is identified and treated must be monitored and re-assessed as the world changes.",
 "ref": "sec-01-governance-in-operation-a-first-look",
 "reflabel": "Governance in operation"
}
</script>
</div>
```
...
::: {#exr-01-jobs-interactive}
## Three jobs of controls, interactive

Sort the controls by when they act.
...
<script type="application/json">
{
 ...
 "chips": [
  ...
  {
   "t": "An alert on abnormal traffic",
   "b": "det"
  },
  {
   "t": "The monthly log review",
   "b": "det"
  },
  {
  ...
  {
   "t": "The incident recovery procedure",
   "b": "corr"
  }
 ],
 "explain": "Preventive controls stop the incident, detective controls see it happening, corrective controls repair the damage - prevention alone is never enough.",
 "ref": "sec-01-the-core-vocabulary-from-threat-to",
 "reflabel": "The core vocabulary"
}
</script>
