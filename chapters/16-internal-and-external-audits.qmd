...
::: {#exr-16-run-interactive}
## How an audit runs, interactive

Order the phases of an audit after ISO 19011.
...
<script type="application/json">
{
 "steps": [
  ...
  "Opening meeting",
  "Fieldwork - evidence and testing",
  "Reporting the findings",
  "Follow-up on remediation"
 ],
 "explain": "An audit is a process, not a visit: Planned on risk, opened formally, evidenced, reported, and followed up.",
 "ref": "sec-16-how-an-audit-runs",
 "reflabel": "How an audit runs"
}
</script>
</div>
```
...
::: {#exr-16-evidence-interactive}
## Evidence techniques, interactive

Match each auditor's action to the technique.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "Asking the admin how leavers are deactivated",
   "b": "inq"
  },
  {
   "t": "Watching a restore being run",
   "b": "obs"
  },
  {
   "t": "Reading the access-review records",
   "b": "insp"
  },
  {
   "t": "Re-running the control themselves on a sample",
   "b": "reperf"
  }
 ],
 "explain": "The techniques form a ladder of strength: Asking, watching, reading, and finally re-doing the control yourself.",
 "ref": "sec-16-evidence-and-testing",
 "reflabel": "Evidence and testing"
}
</script>
</div>
```
...
::: {#exr-16-findings-interactive}
## Rating the findings, interactive
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "No risk assessment exists at all",
   "b": "major"
  },
  {
   "t": "Two of twelve monthly access reviews were skipped",
   "b": "minor"
  },
  {
   "t": "The policy wording could name the owner more clearly",
   "b": "obs"
  }
 ],
 "explain": "Severity follows the gap: A missing mandatory element is major, a lapse in an otherwise working control minor, advice an observation.",
 "ref": "sec-16-findings-and-fixing",
 "reflabel": "Findings, and fixing"
}
</script>
</div>
```
...
::: {#exr-16-intext-interactive}
## Internal or external? Interactive

Sort the audit characteristics.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "Reports inside the organisation, for improvement",
   "b": "int"
  },
  {
   "t": "Scope as broad as its charter allows",
   "b": "int"
  },
  {
   "t": "Certification by an accredited body",
   "b": "ext"
  },
  {
   "t": "An ISAE 3402 report for customers",
   "b": "ext"
  }
 ],
 "explain": "Internal audit serves the organisation's improvement; external audit gives third parties assurance - both need independence.",
 "ref": "sec-16-internal-and-external",
 "reflabel": "Internal and external"
}
</script>
</div>
```
...
::: {#exr-16-todtoe-interactive}
## Design or operation? Interactive

Sort the auditor's two questions about a control.
...
<script type="application/json">
{
 "buckets": [
  ...
  },
  {
   ...
   "desc": "did it run, all period"
  }
 ],
 "chips": [
  {
   "t": "Reading the procedure and judging its logic",
   "b": "tod"
  },
  {
   "t": "Would this review catch a leaver's account?",
   "b": "tod"
  },
  {
   "t": "Sampling twelve months of completed reviews",
   "b": "toe"
  },
  {
   "t": "Re-running the control on last quarter's data",
   "b": "toe"
  }
 ],
 "explain": "Design first, then operation: A well-designed control that never ran fails the second test.",
 "ref": "sec-16-evidence-and-testing",
 "reflabel": "Evidence and testing"
}
</script>
