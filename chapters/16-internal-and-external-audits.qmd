...
traces one clear *audit trail*: Requirement ("MFA on logins") $\rightarrow$
control (MFA enabled) $\rightarrow$ evidence (configuration and logs)
$\rightarrow$ test (try without). A control with no trail is just a claim.
