...
::: {#exr-22-cycle-interactive}
## The course as one cycle, interactive

Order the GRC cycle the twenty-two lectures walked.
...
<script type="application/json">
{
 "steps": [
  ...
  "Know the assets and the law",
  "Assess the risks",
  "Select and tailor controls",
  "Prepare, document, build culture",
  "Audit, evaluate, improve"
 ],
 "explain": "The course is one loop walked once: Understand, assess, control, prepare, audit - and improve into the next pass.",
 "ref": "sec-22-the-whole-picture",
 "reflabel": "The whole picture"
}
</script>
</div>
```
...
::: {#exr-22-exam-interactive}
## The exam skeleton, interactive

Order the five-step method that travels to any case.
...
{
 "steps": [
  "Identify the assets and what they are worth",
  "Name the threats and formulate the risks",
  "Rate likelihood and consequence",
  "Choose proportionate controls",
  "State the residual risk and who accepts it"
 ],
 "explain": "The five steps travel to any case: Assets, risks, ratings, controls, and a governed residual.",
 "ref": "sec-22-the-exam-and-a-method-that",
 "reflabel": "The exam, and a method that travels"
}
</script>
</div>
```
...
::: {#exr-22-traps-interactive}
## The four traps, interactive

Match each description to the trap.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "Meeting the letter of a rule, missing its point",
   "b": "tick"
  },
  {
   "t": "Visible controls that reduce no real risk",
   "b": "theatre"
  },
  {
   "t": "So many controls the business grinds to a halt",
   "b": "over"
  },
  {
   "t": "Policies and registers nobody reads or updates",
   "b": "shelf"
  }
 ],
 "explain": "All four traps produce visible activity without judgement - and share one cure: Ask which real risk this reduces.",
 "ref": "sec-22-the-common-pitfalls",
 "reflabel": "The common pitfalls"
}
</script>
</div>
```
...
::: {#exr-22-compsec-interactive}
## Compliance versus security, interactive

Select the statements the chapter defends.
...
<script type="application/json">
{
 "options": [
  {
   "t": "You can be fully compliant and still be breached",
   "ok": true
  },
  {
   "t": "The rules are a floor set for everyone; your risks are specific",
   "ok": true
  },
  {
   "t": "A certificate is a snapshot of one day",
   "ok": true
  },
  {
   "t": "Certification guarantees safety",
   "ok": false
  },
  {
   "t": "Compliance is the goal; security follows",
   "ok": false
  }
 ],
 "explain": "Compliance is a floor and a snapshot; security is specific to your risks. Aim for security and let compliance follow as evidence.",
 "ref": "sec-22-the-common-pitfalls",
 "reflabel": "The common pitfalls"
}
</script>
...
::: {#exr-22-artefacts-interactive}
## The artefact shelf, interactive

Match each artefact to where the course built it.
...
<script type="application/json">
{
 "buckets": [
  ...
  {
   "id": "ctrl",
   "label": "Controls and the SoA (Ch. 6, 10)"
  },
  {
   "id": "priv",
   "label": "Privacy (Ch. 7, 9)"
  },
  {
   "id": "third",
   "label": "Third-party risk (Ch. 19)"
  }
 ],
 "chips": [
  {
   "t": "The scope statement of Clause 4.3",
   "b": "isms"
  },
  {
   "t": "The Statement of Applicability",
   "b": "ctrl"
  },
  {
   "t": "The DPIA",
  ...
  {
   "t": "The supplier register",
   "b": "third"
  }
 ],
 "explain": "The artefacts are one connected file: Each chapter built a piece, and the register ties them together.",
 "ref": "sec-22-fastgoods-end-to-end",
 "reflabel": "FastGoods, end to end"
}
</script>
</div>
```
