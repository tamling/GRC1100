...
::: {#exr-02-bmc-interactive}
## The Business Model Canvas, interactive

Assign each FastGoods item to the Canvas building block where it belongs.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "Busy urban households",
   "b": "seg"
  },
  {
   "t": "Groceries delivered the same day",
   "b": "vp"
  },
  {
   "t": "The webshop and the app",
   "b": "chan"
  },
  {
 ...
 "explain": "The Canvas shows how the company creates value - and every block it names is something security may have to protect.",
 "ref": "sec-02-the-first-lens-the-business-model",
 "reflabel": "The first lens"
}
</script>
</div>
```
...
::: {#exr-02-valuechain-interactive}
## The value chain, interactive

Put Porter's primary activities into their order along the chain.
...
<script type="application/json">
{
 ...
 "explain": "Porter's five primary activities run from goods coming in to after-sales service; margin - and IT dependency - accumulates along the chain.",
 "ref": "sec-02-the-second-lens-the-value-chain",
 "reflabel": "The second lens"
}
</script>
</div>
```
...
::: {#exr-02-lens-interactive}
## Three lenses, interactive

Each question is answered by one lens of this chapter - match them.
...
<script type="application/json">
{
 "buckets": [
  ...
  {
   "id": "bpmn",
   "label": "Process model (BPMN)"
  }
 ],
 "chips": [
  {
   "t": "How does the company create and capture value?",
   "b": "bmc"
  },
  {
   "t": "Which activities add margin, and where do they depend on IT?",
   "b": "chain"
  },
  {
   "t": "In what order does the order-to-cash work actually flow?",
   "b": "bpmn"
  }
 ],
 "explain": "Each lens answers one question: The Canvas the value question, the chain the activity question, the process model the order-of-work question.",
 "ref": "sec-02-from-business-understanding-to-security-priorities",
 "reflabel": "From business understanding to security priorities"
}
</script>
</div>
```
...
::: {#exr-02-porter-interactive}
## Primary or support activity? Interactive

Sort Porter's activities.
...
<script type="application/json">
{
 ...
 "explain": "Primary activities touch the product on its way to the customer; support activities (HR, procurement, technology) enable them from below.",
 "ref": "sec-02-the-second-lens-the-value-chain",
 "reflabel": "The second lens"
}
</script>
...
::: {#exr-02-orderproc-interactive}
## The order process, interactive

Order the steps of FastGoods' order-to-delivery process.
...
<script type="application/json">
{
 ...
 "explain": "The modelled order process is where the running risks live: The payment step carries R2, the customer data behind it R1 and R3.",
 "ref": "sec-02-the-third-lens-processes-and-modelling",
 "reflabel": "The third lens"
}
</script>
</div>
```
