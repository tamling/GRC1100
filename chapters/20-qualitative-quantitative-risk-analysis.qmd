...
::: {#exr-20-twoways-interactive}
## Two ways to measure, interactive
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "Levels judged and placed on a matrix",
   "b": "qual"
  },
  {
   "t": "Fast enough to screen a whole register",
   "b": "qual"
  },
  {
   "t": "Expected annual loss in money",
   "b": "quant"
  },
  {
   "t": "Supports cost-benefit arithmetic (ROSI)",
   "b": "quant"
  },
  {
   "t": "Vulnerable to false precision",
   "b": "quant"
  },
  {
   "t": "Vulnerable to subjective bias",
   "b": "qual"
  }
 ],
 "explain": "Levels are fast and comparable but subjective; numbers support arithmetic but invite false precision - each fails differently.",
 "ref": "sec-20-two-ways-to-measure",
 "reflabel": "Two ways to measure"
}
</script>
</div>
```
...
::: {#exr-20-ale-interactive}
## Building the ALE, interactive

Order the quantitative chain.
...
<script type="application/json">
{
 "steps": [
  ...
  "ALE = SLE × ARO",
  "Compare the ALE with the control's cost"
 ],
 "explain": "The ALE chain turns a scenario into money - and the money can be compared with the control's cost.",
 "ref": "sec-20-the-quantitative-way",
 "reflabel": "The quantitative way"
}
</script>
</div>
```
...
::: {#exr-20-sources-interactive}
## Where the numbers come from, interactive
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "Last year's three checkout outages and their costs",
   "b": "own"
  },
  {
   "t": "The median breach cost in retail (e.g. DBIR)",
   "b": "studies"
  },
  {
   "t": "The premium quoted for cyber cover",
   "b": "insurance"
  }
 ],
 "explain": "Your own records first, because they describe your organisation; studies and insurance prices calibrate the rest.",
 "ref": "sec-20-where-the-numbers-come-from",
 "reflabel": "Where the numbers come from"
}
</script>
</div>
```
...
::: {#exr-20-critics-interactive}
## What the critics say, interactive

Select the documented weaknesses of qualitative matrices.
...
<script type="application/json">
{
 "options": [
  {
   "t": "Range compression - unequal risks share a cell",
   "ok": true
  },
  {
   "t": "Rank reversal - the ordering can flip",
   "ok": true
  },
  {
   "t": "Arithmetic on ordinal scales is not sound",
   "ok": true
  },
  {
   "t": "Matrices are illegal under EU law",
   "ok": false
  },
  {
   "t": "Qualitative levels always overstate risk",
   "ok": false
  }
 ],
 "explain": "Cox documented the failures formally: Compressed ranges, reversible rankings, and arithmetic ordinal scales cannot carry.",
 "ref": "sec-20-what-the-critics-say",
 "reflabel": "What the critics say"
}
</script>
</div>
```
...
::: {#exr-20-choosing-interactive}
## The choosing rule, interactive

Order the chapter's closing advice.
...
{
 "steps": [
  "Screen the whole register qualitatively",
  "Deepen the big decisions quantitatively",
  "Be honest about the uncertainty either way"
 ],
 "explain": "Screen broadly, deepen selectively, stay honest about uncertainty - the two approaches are stages, not rivals.",
 "ref": "sec-20-choosing-an-approach",
 "reflabel": "Choosing an approach"
}
</script>
</div>
```
