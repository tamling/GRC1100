...
::: {#exr-04-cia-incidents-interactive}
## Which property failed? Interactive

For each incident, pick the CIA property that was primarily violated.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "Customer records leaked and traded",
   "b": "c"
  },
  {
   "t": "Prices silently altered in the database",
   "b": "i"
  },
  {
   "t": "Checkout unreachable during a DDoS",
   "b": "a"
  },
  {
   "t": "A backup that cannot be restored when needed",
   "b": "a"
  },
  {
   "t": "An order changed after confirmation, undetected",
   "b": "i"
  },
  {
   "t": "Staff browsing records they have no need to see",
   "b": "c"
  }
 ],
 "explain": "Ask what failed: Who saw it (confidentiality), was it silently changed (integrity), could it be reached (availability).",
 "ref": "sec-04-the-cia-triad-in-depth",
 "reflabel": "The CIA triad, in depth"
}
</script>
</div>
```
...
::: {#exr-04-actors-interactive}
## Threat actors and motives, interactive

Match each threat actor to its typical primary motivation.
...
<script type="application/json">
{
 "buckets": [
  ...
  {
   "id": "espionage",
   "label": "Espionage / strategy"
  },
  {
   "id": "ideology",
   "label": "Ideology / attention"
  },
  {
   "id": "grievance",
   "label": "Grievance or error"
  }
 ],
 "chips": [
  {
   "t": "Ransomware-as-a-service crew",
   "b": "money"
  },
  {
   "t": "State-sponsored group",
   "b": "espionage"
  },
  {
   "t": "Hacktivists defacing the homepage",
   "b": "ideology"
  },
  {
   "t": "A disgruntled or careless insider",
   "b": "grievance"
  }
 ],
 "explain": "Motivation predicts behaviour: Money seeks scale, espionage seeks persistence, ideology seeks attention, insiders act from access.",
 "ref": "sec-04-threats-and-vulnerabilities",
 "reflabel": "Threats and vulnerabilities"
}
</script>
</div>
```
...
::: {#exr-04-chain-interactive}
## From threat to impact, interactive

Arrange the chain a real incident follows.
...
<script type="application/json">
{
 ...
 "explain": "A threat source uses a vector against a vulnerability; only then is there an incident, and only the incident lands as business impact.",
 "ref": "sec-04-from-threat-to-impact",
 "reflabel": "From threat to impact"
}
</script>
</div>
```
...
::: {#exr-04-classify-interactive}
## Classify the assets, interactive

Drag each FastGoods asset onto its classification level.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "The product catalogue",
   "b": "pub"
  },
  {
   "t": "Internal pricing rules",
   "b": "int"
  },
  {
 ...
 "explain": "Classification puts the strongest controls where the sensitivity is: The catalogue is meant to be public, the credentials never.",
 "ref": "sec-04-categorising-the-assets",
 "reflabel": "Categorising the assets"
}
</script>
</div>
```
...
::: {#exr-04-malware-interactive}
## Know your malware, interactive

Match each behaviour to the malware type.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "Encrypts the data and demands payment",
   "b": "ransom"
  },
  {
   "t": "Spreads from machine to machine by itself",
   "b": "worm"
  },
  {
   "t": "Arrives disguised as something useful",
   "b": "trojan"
  },
  {
   "t": "Quietly observes and exfiltrates",
   "b": "spy"
  }
 ],
 "explain": "Ransomware extorts, worms self-propagate, trojans deceive their way in, spyware watches - the names describe the behaviour.",
 "ref": "sec-04-threats-and-vulnerabilities",
 "reflabel": "Threats and vulnerabilities"
}
</script>
