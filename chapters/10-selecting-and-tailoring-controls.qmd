...
auditors. One refinement from the catalogue matters for selection: The
functional classification. Chapter 1 gave the working three --- preventive,
detective, corrective --- and ISO 27002:2022 tags every control with exactly
this attribute; the fuller professional set adds *deterrent* (discourage the
...
and user friction, weighed against the reduction in likelihood $\times$ impact
...
::: {#tbl-costbenefit}
  **Candidate (for R1)**          **Cost / yr**              **Effect**                  **Verdict**
  ------------------------------- -------------------------- --------------------------- ----------------------------------------------------
  MFA via identity provider       $\sim$EUR 5k               Likelihood high $\to$ low   Yes --- large reduction per euro
