...
<script type="application/json">
{
 ...
 "explain": "Reduce, transfer, avoid, accept - every rated risk gets exactly one deliberate decision, recorded.",
 "ref": "sec-10-a-rated-risk-needs-a-decision",
 "reflabel": "A rated risk needs a decision"
}
</script>
</div>
```
...
<script type="application/json">
{
 ...
 "explain": "GITCs secure the environment every application relies on; application controls live inside one system's transactions.",
 "ref": "sec-10-the-audit-view-gitc-and-application",
 "reflabel": "The audit view"
}
</script>
</div>
```
...
<script type="application/json">
{
 ...
 "explain": "Design asks whether the control would work; operation asks whether it actually ran, with evidence - auditors test both.",
 "ref": "sec-10-tailoring-cost-and-residual-risk",
 "reflabel": "Tailoring, cost, and residual risk"
}
</script>
</div>
```
...
<script type="application/json">
{
 ...
 "explain": "Defence in depth layers independent controls so that one failure does not expose everything behind it.",
 "ref": "sec-10-choosing-controls-and-layering-them",
 "reflabel": "Choosing controls, and layering them"
}
</script>
</div>
```
...
<script type="application/json">
{
 ...
 "explain": "Acceptance is a governed decision: Recorded, signed at the right level, and revisited - never a silent default.",
 "ref": "sec-10-tailoring-cost-and-residual-risk",
 "reflabel": "Tailoring, cost, and residual risk"
}
</script>
