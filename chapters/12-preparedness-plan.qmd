...
::: {#exr-12-phases-interactive}
## The incident cycle, interactive
...
<script type="application/json">
{
 ...
 "explain": "The cycle runs from preparation through detection, containment and recovery into learning - and the learning feeds the next preparation.",
 "ref": "sec-12-the-response-plan-and-its-phases",
 "reflabel": "The response plan and its phases"
}
</script>
</div>
```
...
::: {#exr-12-targets-interactive}
## Recovery targets, interactive

Match each definition to its recovery target.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "How quickly the service must be running again",
   "b": "rto"
  },
  {
   "t": "How much data loss, measured in time, is tolerable",
   "b": "rpo"
  },
  {
   "t": "The outage length beyond which the business may not survive",
   "b": "mtd"
  }
 ],
 "explain": "RTO bounds the restore time, RPO the data loss, MTD the survival horizon - the BIA sets all three per service.",
 "ref": "sec-12-critical-services-and-recovery-targets",
 "reflabel": "Critical services and recovery targets"
}
</script>
</div>
```
...
::: {#exr-12-ladder-interactive}
## The exercise ladder, interactive

Order the ways of testing the plan, in rising cost and realism.
...
<script type="application/json">
{
 "steps": [
  "Tabletop exercise",
  "Simulation / drill of one part",
  "Full exercise, end to end"
 ],
 "explain": "Start cheap and honest: The tabletop finds role gaps, the drill proves RTO and RPO, the full exercise rehearses the whole.",
 "ref": "sec-12-test-and-improve",
 "reflabel": "Test and improve"
}
</script>
</div>
```
...
::: {#exr-12-biaplan-interactive}
## BIA or response plan? Interactive

Sort the artefacts of preparedness.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "The list of critical services",
   "b": "bia"
  },
  {
   "t": "RTO and RPO per service",
   "b": "bia"
  },
  {
   "t": "Roles and the call tree",
   "b": "plan"
  },
  {
   "t": "The phases from detection to recovery",
   "b": "plan"
  }
 ],
 "explain": "The BIA says what matters and how fast it must return; the plan says who does what when it fails.",
 "ref": "sec-12-critical-services-and-recovery-targets",
 "reflabel": "Critical services and recovery targets"
}
</script>
...
::: {#exr-12-r2timeline-interactive}
## R2, end to end - interactive

Order the worked denial-of-service timeline.
...
{
 "steps": [
  "Abnormal traffic detected on the checkout",
  "Mitigation activated with the DDoS service",
  "Checkout restored within the RTO",
  "Post-incident report and lessons learned"
 ],
 "explain": "The worked R2 timeline shows preparedness paying off: Detection, mitigation, restoration inside the RTO, then lessons.",
 "ref": "sec-12-the-response-plan-and-its-phases",
 "reflabel": "The response plan and its phases"
}
</script>
