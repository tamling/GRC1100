...
::: {#exr-15-hierarchy-interactive}
## The document hierarchy, interactive

Order the four levels, top first.
...
<script type="application/json">
{
 "steps": [
  "Policy - what and why",
  "Standard - the measurable rules",
  "Procedure - how, step by step",
  "Record - the evidence it happened"
 ],
 "explain": "Policy states what and why, standards make it measurable, procedures make it doable, records prove it happened.",
 "ref": "sec-15-the-document-hierarchy",
 "reflabel": "The document hierarchy"
}
</script>
</div>
```
...
::: {#exr-15-dora-interactive}
## DORA's five pillars, interactive

Match each activity to the DORA pillar it lives under.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "Keeping the register of information on providers",
   "b": "third"
  },
  {
   "t": "Reporting a major ICT incident to the supervisor",
   "b": "incid"
  },
  {
  ...
  {
   "t": "The board-approved ICT risk framework",
   "b": "riskm"
  },
  {
   "t": "Exchanging threat intelligence with peers",
   "b": "share"
  }
 ],
 "explain": "DORA's five pillars run from the risk framework through incidents, testing and third parties to information sharing.",
 "ref": "sec-15-dora-resilience-as-law",
 "reflabel": "DORA: Resilience as law"
}
</script>
</div>
```
...
::: {#exr-15-levels-interactive}
## Which level? Interactive

Place each document on its level of the hierarchy.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "The acceptable-use policy",
   "b": "pol"
  },
  {
   "t": "Minimum password length of 12 characters",
   "b": "std"
  },
  {
   "t": "The steps to reset a user's MFA",
   "b": "proc"
  },
  {
   "t": "The signed access review of March",
   "b": "rec"
  }
 ],
 "explain": "Each document lives on one level - and an auditor will ask for the record, not the policy.",
 "ref": "sec-15-the-document-hierarchy",
 "reflabel": "The document hierarchy"
}
</script>
...
::: {#exr-15-symptoms-interactive}
## Failing document control, interactive

Select the failure symptoms the chapter names.
...
<script type="application/json">
{
 "options": [
  {
   "t": "Two conflicting versions in circulation",
   "ok": true
  },
  {
   "t": "No named owner",
  ...
  {
   "t": "Review dates years in the past",
   "ok": true
  },
  {
   "t": "Documents carry version numbers",
   "ok": false
  },
  {
   "t": "Procedures are kept short",
   "ok": false
  }
 ],
 "explain": "Conflicting versions, missing owners and stale review dates are the classic symptoms of documentation nobody governs.",
 "ref": "sec-15-keeping-documentation-useful",
 "reflabel": "Keeping documentation useful"
}
</script>
</div>
```
...
::: {#exr-15-doranis-interactive}
## DORA or NIS2? Interactive

Sort the features of the two regimes.
...
<script type="application/json">
{
 ...
 "chips": [
  {
   "t": "An EU regulation, directly applicable",
   "b": "dora"
  },
  {
   "t": "Threat-led penetration testing (TLPT)",
  ...
  {
   "t": "The register of information on ICT providers",
   "b": "dora"
  },
  {
   "t": "A directive, transposed by member states",
   "b": "nis2"
  },
  {
   "t": "Covers sectors from energy to health",
   "b": "nis2"
  }
 ],
 "explain": "DORA is a directly applicable regulation for finance with its own instruments (TLPT, the register); NIS2 is a directive across sectors.",
 "ref": "sec-15-dora-resilience-as-law",
 "reflabel": "DORA: Resilience as law"
}
</script>
